...
class ComparesControllerTest < ActionController::TestCase
  ...
  test "should create compare" do
    assert_difference('Compare.count') do
      post :create, compare: { collections: @compare.collections, name: @compare.name, offers: @compare.offers }
    end
  ...
  test "should update compare" do
    patch :update, id: @compare, compare: { collections: @compare.collections, name: @compare.name, offers: @compare.offers }
    assert_redirected_to compare_path(assigns(:compare))
  end
